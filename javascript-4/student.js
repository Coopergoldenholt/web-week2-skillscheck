...
let me = {
    firstname: 'Cooper',
    superHeroName: 'Super Cooper',
    homeTown: 'Riverton',
    superPowers: ['flying', 'teleportation', 'super strength'],
...
//superHeroName property on the me object. The last variable you should create is 'homeTown' which will be the value of 
//homeTown on the me object
...
//Outside of the for loop but still inside of setColor, 
...
//That is what this function will do. In your function, loop over the obj parameter passed in, 
//and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, 
