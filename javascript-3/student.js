...
let groceries = ['eggs', 'bread', 'steak']
...
//Inside of addItem, invoke displayData() which is a function you
// did not create (we did) that takes care of some of the work for getting your page to display correctly.
...
//Inside of the removeItem function, remove the item that corresponds to the index parameter from the groceries array 
//above by using splice. Then, invoke the displayData() function inside of your removeItem function.
...
//ou're going to check the total number of groceries in your groceries array using .length. Using an if/else statement, 
//check if the number of groceries is greater than or equal to 5. If it is, return the string 
